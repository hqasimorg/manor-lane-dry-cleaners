...
const pricingCategories = [
  {
    name: "Dry Cleaning",
    items: [
      { item: "Shirt (Wash & Press)", price: "£2.50" },
      { item: "2 pc Suit", price: "£12.00" },
      { item: "Dress Suit", price: "£15.00" },
      { item: "Blouse", price: "£6.00" },
      { item: "Trouser", price: "£6.00" },
      { item: "Dress", price: "£10.00" },
      { item: "Suit Jacket", price: "£9.50" },
      { item: "Waistcoat", price: "£5.50" },
      { item: "Coat", price: "£15.00" },
      { item: "Jumper", price: "£6.50" },
      { item: "Skirt", price: "£6.00" },
      { item: "Scarf", price: "£5.50" },
      { item: "Tie", price: "£3.00" },
    ],
  },
  {
